...
| Категория | Характеристика | Токены в промпте |
|---|---|---|
| Static / Micro | Только дыхание, ветер, пыль. Макросъёмка | `subtle micro-vibration, barely perceptible movement` |
| Natural | Обычное движение человека, животного, транспорта | `steady natural movement, smooth controlled motion` |
| Cinematic | Экшен, драматика, спорт, контролируемый хаос | `dynamic fast motion, dramatic action, rapid camera tracking` |
| Hyper / Chaos | Разрушение, высокоскоростные переходы, shake | `extreme high-velocity motion, chaotic destruction, violent impact` |

---

### Рекомендации по типам сцен

| Тип сцены | Интенсивность | Режим | Обоснование |
|---|---|---|---|
| Макро капля / Impact | Cinematic | 5s | Быстрый удар, короткое действие |
| Портрет / Lip-sync | Static/Micro | 10-15s | Минимум движения, максимум детали лица |
| Жидкая трансформация | Natural→Cinematic | 15s | Плавный морфинг, нужно время |
| Reveal автомобиля | Natural | 10-15s | Плавное движение камеры, детали |
| Огонь / взрыв | Hyper/Chaos | 10-15s | Хаотичная динамика, debris |
| Термальный контакт | Cinematic | 10-15s | Активная реакция материалов |
| Атмосфера / среда | Static/Micro | 10-15s | Медленное накопление деталей |
| Персонаж идёт | Natural | 10s | Естественное движение |
| Разрушение / краш | Hyper/Chaos | 5-10s | Максимальный хаос, быстро |
| Ткань на ветру | Natural | 10s | Органичное колыхание |
| Стекло бьётся | Cinematic→Hyper | 5s | Быстрый импульс, разлёт осколков |
| Продуктовый макро | Static/Micro | 10-15s | Статика с микродеталями |

### Правило совмещения интенсивности и Duration

    Static/Micro         → предпочтителен режим 10-15s
    Natural              → любой режим 5-15s
    Cinematic            → режим 5-10s
    Hyper/Chaos          → предпочтителен режим 5-10s

### Критическое правило
Hyper/Chaos в режиме 15s — почти всегда даёт артефакты.
Kling теряет консистентность субъекта при высокой интенсивности на длинных клипах.
